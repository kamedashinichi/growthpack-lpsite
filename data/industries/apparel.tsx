...
export const apparelData: IndustryLPData = {
  ...
  featureSection: {
    ...
    items: [
      ...
      { image: "/images/セグメント配信.png", name: "セグメント配信", description: "休眠会員の掘り起こし・VIP向け先行案内を自動化", url: "/segment" },
      { image: "/images/1to1.png", name: "1to1コミュニケーション", description: "担当交代しても対話履歴を引き継ぎ。属人化を解消", url: "/1to1" },
