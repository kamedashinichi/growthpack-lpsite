    ...
    <main className="min-h-screen bg-white text-foreground">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 max-w-[600px] space-y-6 md:space-y-7">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-[1.15] tracking-tight text-foreground">
                離脱しそうなお客様に、<br />
                ちょうどいいタイミングで<br />
                <span className="text-line-green-dark">「また来る理由」</span>を届ける。
              </h1>
              <p className="text-base sm:text-lg text-foreground/80 leading-relaxed max-w-[600px]">デジタルスタンプで来店回数を可視化。ゴール接近通知・離脱予兆検知・クーポン自動配布で、リピート率を仕組みで高めます。</p>
      ...
      <Section id="how-to" spacing="md" container="wide" background="white">
        ...
        <ol className="max-w-[800px] space-y-4">
          <li className="bg-secondary rounded-xl border border-border p-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">スタンプ付与条件・ランク設計・既存POSとの連携要否をお聞きし、概算費用と工期をご提示します。</p>
          </li>
          <li className="bg-secondary rounded-xl border border-border p-6">
            <h3 className="text-lg font-bold text-foreground mb-2">2. 設計・実装（1〜2ヶ月）</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">QRスタンプ付与・ゴール接近通知・クーポン自動配布・離脱予兆検知の設計と実装を行います。</p>
          </li>
          <li className="bg-secondary rounded-xl border border-border p-6">
      ...
      <Section id="related-features" spacing="md" container="wide" background="muted">
        <div className="max-w-[720px] mb-8">
          ...
          <p className="text-base text-muted-foreground">スタンプカードと同じ「エンゲージメント強化」ステップの機能です。組み合わせることでリピート施策の精度が高まります。</p>
        </div>
      ...
      <Section id="contact" spacing="lg" container="default" background="dark">
        <div className="text-center space-y-6 md:space-y-8">
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-[640px] mx-auto leading-relaxed">スタンプ付与条件・ランク設計・複数店舗の管理要件をお聞きして、最適な構成をご提案します。<span className="font-bold text-white">初回相談は無料です。</span></p>
      ...
      <LpFooter
        description="クラスメソッド株式会社が提供するLINEミニアプリ開発サービス。スタンプカードでリピート来店を仕組み化します。"
        columns={[
          {
            heading: 'SERVICE',
            links: (
