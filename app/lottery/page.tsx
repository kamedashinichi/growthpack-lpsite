          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 max-w-[600px] space-y-6 md:space-y-7">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-[1.15] tracking-tight text-foreground">
                当たっても外れても、<br />
                次の来店につながる体験を<br />
                <span className="text-line-green-dark">自動化する。</span>
              </h1>
              <p className="text-base sm:text-lg text-foreground/80 leading-relaxed max-w-[600px]">LINE上で抽選から当選通知・クーポン配布・会員データ蓄積まで一気通貫。ハズレ参加賞で全員に来店動機を残します。</p>
      ...
      <Section id="contact" spacing="md" container="wide" background="dark">
        ...
        <div className="mb-16 md:mb-24">
          ...
          <ol className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {[
              { title: '要件ヒアリング・見積（〜2週間）', body: '抽選のユースケース・景品形態・チケットとの入場制御連携の要否をお聞きし、概算費用と工期をご提示します。' },
              { title: '設計・実装（1〜2ヶ月）', body: '抽選ロジック・当落判定・当選通知・クーポン自動配布・参加賞クーポンの設計と実装を行います。不正対策・参加資格制御も並列で進行します。' },
