        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-5">
          ...
          <Card variant="outline" padding="md">
            ...
            <ul className="text-sm text-[#6B7280] space-y-2">
              ...
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-[#FCD34D] shrink-0" />調剤連携: △</li>
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-[#FCD34D] shrink-0" />マルチチェーン: △</li>
            </ul>
          </Card>
          ...
          <Card variant="accent" padding="md" className="ring-2 ring-[#06C755] shadow-lg relative">
            ...
            <ul className="text-sm text-[#1F2937] space-y-2 font-medium">
              ...
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-[#06C755] shrink-0" />調剤連携: ◎</li>
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-[#06C755] shrink-0" />マルチチェーン: ◎</li>
            </ul>
          </Card>
