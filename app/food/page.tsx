...
export default function FoodPage() {
  return (
    <main className="min-h-screen bg-white text-foreground">
      ...
      />
      <ScrollTracker sections={['problems', 'appeal', 'positioning', 'features', 'faq', 'contact']} />
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 md:space-y-7">
              ...
              <h1 className="text-4xl md:text-5xl font-bold leading-[1.2] tracking-tight text-white">
                行列、リピート、テイクアウト。<br />
                飲食の顧客接点を<span className="text-line-green">LINEで設計する。</span>
              </h1>
                    ...
                    <div className="bg-white rounded-[22px] overflow-hidden">
                      ...
                      <div className="p-3 space-y-2.5 bg-secondary">
                        ...
                        <div className="bg-line-green-extra-light rounded-md px-2 py-1.5 border border-line-green/20">
                          ...
                          <div className="text-[10px] text-foreground">スタンプ獲得</div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <Section spacing="sm" container="wide" background="white">
        ...
        <p className="text-xs text-muted-foreground text-center mt-4">※ 導入効果は企業規模・既存システム・施策設計によって異なります。</p>
      </Section>
      ...
      <Section id="problems" spacing="sm" container="wide" background="muted">
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base text-muted-foreground">ピーク時の機会損失を入口に、注文データ活用と自社チャネル化の3層を順に整備します。</p>
        </div>
      ...
      <Section id="appeal" spacing="md" container="wide" background="white">
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base text-muted-foreground">デジタルの接点から始め、再来店を仕組みで回し、自社の収益基盤を強化する。飲食チェーンに合わせた導入順序です。</p>
        </div>
      ...
      <Section id="positioning" spacing="md" container="wide" background="muted">
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base text-muted-foreground">SaaSはマルチブランドや既存POSとの連携で詰まり、フルスクラッチは期間とコストが膨らむ。グロースパックは<span className="font-bold text-foreground">速さ・柔軟性・マルチブランド対応</span>を同時に提供するハーフスクラッチ開発です。</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-5">
          ...
          <Card variant="outline" padding="md">
            ...
            <ul className="text-sm text-muted-foreground space-y-2">
              ...
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-accent-yellow shrink-0" />マルチブランド: △</li>
          ...
          <Card variant="accent" padding="md" className="ring-2 ring-line-green shadow-lg relative">
            ...
            <ul className="text-sm text-foreground space-y-2 font-medium">
              ...
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-line-green shrink-0" />マルチブランド: ◎</li>
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-line-green shrink-0" />POS連携: ○ / 拡張性: ○</li>
            </ul>
          </Card>
      ...
      <Section id="features" spacing="md" container="wide" background="white">
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base text-muted-foreground">飲食業界で特に効く7機能。必要なものだけを選び、フェーズを追って拡張できます。</p>
        </div>
        ...
        <div className="bg-white rounded-2xl overflow-hidden border border-border shadow-sm">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-6 sm:p-8 md:p-10 flex flex-col justify-center md:w-3/5">
              ...
              <WPDownloadButton industry="food" />
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section id="contact" spacing="lg" container="default" background="dark">
        <div className="text-center space-y-6 md:space-y-8">
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-[640px] mx-auto leading-relaxed">業態・ブランド数・既存POSをお聞きして、最適な構成をご提案します。<span className="font-bold text-white">初回相談は無料です。</span></p>
      ...
      {/* ============================================================ */}
      <LpFooter
        description="クラスメソッド株式会社が提供するLINEミニアプリ開発サービス。飲食業界の順番待ちデジタル化・マルチブランド統合に対応します。"
        columns={[
          {
            heading: 'SERVICE',
            links: (
