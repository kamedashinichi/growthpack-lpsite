          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 max-w-[600px] space-y-6 md:space-y-7">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-[1.15] tracking-tight text-foreground">
                友だち追加するだけで、<br />
                お店が<span className="text-line-green-dark">自分のことを覚えて</span><br className="hidden sm:block" />
                くれる。
              </h1>
              <p className="text-base sm:text-lg text-foreground/80 leading-relaxed max-w-[600px]">LINE友だち追加で会員ID自動発行。来店履歴・ランク・顧客属性を自動蓄積し、スタンプ・配信・クーポンなど全機能の顧客データ基盤を構築します。</p>
      ...
      <Section id="contact" spacing="md" container="wide" background="dark">
        ...
        <div className="mb-16 md:mb-24">
          ...
          <ol className="grid md:grid-cols-3 gap-4 md:gap-6">
            {[
              { title: '要件ヒアリング・見積（〜2週間）', body: '既存の会員基盤・POS・ランク判定ルールをお聞きし、概算費用と工期をご提示します。' },
              { title: '設計・実装（1〜2ヶ月）', body: '会員ID発行・データ基盤・ランク自動判定の設計と実装を行います。既存システム連携も並列で進行します。' },
