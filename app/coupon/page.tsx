    ...
    <main className="min-h-screen bg-white text-foreground">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex-1 max-w-[600px] space-y-6 md:space-y-7">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-[1.15] tracking-tight text-white">
                紙クーポンを廃止し、<br />
                <span className="text-line-green">適切な人に適切な</span><br />
                タイミングで届ける仕組みへ。
              </h1>
      ...
      <Section id="how-to" spacing="md" container="wide" background="white">
        ...
        <ol className="max-w-[800px] space-y-4">
          <li className="bg-secondary rounded-xl border border-border p-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">消込方式・最初に自動化したいトリガー・POS連動の要否をお聞きし、概算費用と工期をご提示します。</p>
          </li>
          <li className="bg-secondary rounded-xl border border-border p-6">
            <h3 className="text-lg font-bold text-foreground mb-2">2. 設計・実装（1〜2ヶ月）</h3>
            <p className="text-sm text-muted-foreground leading-relaxed">クーポン作成・管理・消込・利用状況ダッシュボード・トリガー連動の自動配布を設計・実装します。</p>
          </li>
          <li className="bg-secondary rounded-xl border border-border p-6">
      ...
      <Section id="related-features" spacing="md" container="wide" background="white">
        <div className="max-w-[720px] mb-6">
          ...
          <p className="text-sm text-muted-foreground">「エンゲージメント強化」ステップで一緒に検討される機能です。</p>
        </div>
        <div className="grid sm:grid-cols-3 gap-4 max-w-[900px]">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-bold text-foreground group-hover:text-line-green-dark transition-colors">スタンプカード</p>
              <p className="text-xs text-muted-foreground leading-snug mt-0.5">来店履歴が見える、育つ。紛失ゼロのデジタルスタンプ。</p>
            </div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-bold text-foreground group-hover:text-line-green-dark transition-colors">チケット・パス</p>
              <p className="text-xs text-muted-foreground leading-snug mt-0.5">LINEで入場管理まで完結。CRM側で利用状況を可視化。</p>
            </div>
            <ArrowRight className="w-4 h-4 text-muted-foreground group-hover:text-line-green-dark shrink-0 transition-colors" />
          </Link>
          <Link
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-bold text-foreground group-hover:text-line-green-dark transition-colors">抽選</p>
              <p className="text-xs text-muted-foreground leading-snug mt-0.5">当選体験でエンゲージメントを加速。来店動機に変える。</p>
            </div>
            <ArrowRight className="w-4 h-4 text-muted-foreground group-hover:text-line-green-dark shrink-0 transition-colors" />
          </Link>
        </div>
