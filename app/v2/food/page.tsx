...
const PHASES = [
  {
    phase: 'Phase 1',
    label: '顧客接点の創出',
    features: ['デジタル会員証', '順番待ち'],
    description: 'LINE会員証と順番待ち通知を整備。デジタル接点を立ち上げ、顧客を可視化します。',
  },
  {
    phase: 'Phase 2',
    label: '再来店サイクルの設計',
    features: ['スタンプカード', 'クーポン配信', '予約'],
    description: 'スタンプカード＋クーポン＋予約を実装。来店頻度を高め、テイクアウト導線を自社化します。',
  },
  {
    phase: 'Phase 3',
    label: '関係性の深化',
    features: ['セグメント配信', '1to1コミュニケーション'],
    description: 'セグメント配信でマルチブランドの顧客データを活かし、個別最適なコミュニケーションを実現します。',
  },
];
    ...
    <main className="min-h-screen bg-white text-[#1F2937]">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-[#E5E7EB]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-5 md:px-6 h-16 md:h-20 flex items-center justify-between">
          <Link href="/v2/food" className="flex items-center gap-2">
      ...
      <Section id="phases" spacing="md" container="wide" background="muted">
        <div className="max-w-[720px] mb-10 md:mb-12">
          ...
          <p className="text-base text-[#4B5563]">顧客接点の創出→再来店サイクルの設計→関係性の深化。各フェーズが次のデータ基盤になります。</p>
        </div>
