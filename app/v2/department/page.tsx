...
const PHASES = [
  {
    phase: 'Phase 1',
    label: '一般会員接点の統合',
    features: ['デジタル会員証', 'クーポン配信', 'セグメント配信'],
    description: '館内共通IDで一般顧客を統合。売場横断のデータ基盤を整え、セグメント配信で一斉配信から脱却します。',
  },
  {
    phase: 'Phase 2',
    label: '催事デジタル化',
    features: ['チケット・パス管理', '予約'],
    description: '催事・招待会のチケット発行と入場管理をLINEで完結。来場データが関係深化の材料になります。',
  },
  {
    phase: 'Phase 3',
    label: '外商関係の組織化',
    features: ['1to1コミュニケーション', 'ギフト'],
    description: '外商顧客との接触履歴・嗜好・担当引き継ぎを組織資産として蓄積。ギフト受付体験も整備します。',
  },
];
    ...
    <main className="min-h-screen bg-white text-[#1F2937]">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-[#E5E7EB]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-5 md:px-6 h-16 md:h-20 flex items-center justify-between">
          <Link href="/v2/department" className="flex items-center gap-2">
