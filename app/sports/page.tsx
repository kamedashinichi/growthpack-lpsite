...
const howToJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'スポーツ・エンタメ×LINEミニアプリの導入ステップ',
  description: 'ライト層の接点確保からファン育成、幽霊会員再活性化まで3ステップで段階導入する流れ',
  totalTime: 'P3M',
  step: [
    {
      '@type': 'HowToStep',
      position: 1,
      name: 'ライト層をLINEで捕まえる',
      text: '会員証とチケット・パスで、これまでデータがなかったライト層（年1-2回来場）をLINE IDに紐づけます。独自アプリを持っているファンはそのまま継続利用、ライト層はLINEが窓口になります。',
    },
    {
      '@type': 'HowToStep',
      position: 2,
      name: '来場動機を設計する',
      text: 'チケット先行抽選・限定グッズ配布・来場スタンプを組み合わせ、次の来場理由を継続的に作ります。試合・公演日以外にもLINEで接点を持ち続けることがライト層育成の核心です。',
    },
    {
      '@type': 'HowToStep',
      position: 3,
      name: '払っているが来ない会員を再活性化する',
      text: 'セグメント配信で幽霊会員を検知し、自動フォローで解約前に介入します。解約1件を阻止するコストは新規獲得よりはるかに小さく、フィットネス業界では最も即効性の高い施策です。',
    },
  ],
};
...
const articleJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Article',
  headline: 'スポーツ・エンタメ向けLINEミニアプリ開発｜ライト層接点・コアファン拡張｜グロースパック for LINE',
  description: '年1〜2回来場のライト層への接点不足、コアファン以外の購買機会損失。スポーツ・エンタメ業界の課題をLINEミニアプリで解消。ハーフスクラッチ開発で最短3ヶ月、事業会社向けグロースパック for LINEがファン育成を支援。',
  author: {
    '@type': 'Organization',
    name: 'クラスメソッド株式会社',
    ...
    <main className="min-h-screen bg-white text-foreground">
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 md:space-y-7">
              ...
              <h1 className="text-4xl md:text-5xl font-bold leading-[1.2] tracking-tight text-white">
                コアファンは整備済み。<br />
                ライト層を<span className="text-line-green">育てる。</span>
              </h1>
                    ...
                    <div className="bg-white rounded-[22px] overflow-hidden">
                      ...
                      <div className="p-3 space-y-2.5 bg-secondary">
                        ...
                        <div className="bg-line-green-extra-light rounded-md px-2 py-1.5 border border-line-green/20">
                          <div className="text-[9px] text-line-green-dark font-bold">チケット先行</div>
                          <div className="text-[10px] text-foreground">抽選エントリー受付中</div>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <Section id="problems" spacing="sm" container="wide" background="muted">
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base text-muted-foreground">コアファン向け施策は整備済み。年1-2回来場のライト層をLINEで捕まえ、日常接点を作ることから始めます。</p>
        </div>
      ...
      <Section id="appeal" spacing="md" container="wide" background="white">
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base text-muted-foreground">LINEで捕まえる→来場動機を設計する→幽霊会員を再活性化する。コアファン施策とは独立したライト層育成フローです。</p>
        </div>
      ...
      <Section id="positioning" spacing="md" container="wide" background="muted">
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base text-muted-foreground">SaaSは独自アプリとの連携やセグメント設計で詰まり、フルスクラッチは期間とコストが膨らむ。グロースパックは<span className="font-bold text-foreground">速さ・柔軟性・既存システム連携</span>を同時に提供するハーフスクラッチ開発です。</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-5">
          ...
          <Card variant="outline" padding="md">
            ...
            <ul className="text-sm text-muted-foreground space-y-2">
              ...
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-accent-yellow shrink-0" />既存システム連携: △</li>
          ...
          <Card variant="accent" padding="md" className="ring-2 ring-line-green shadow-lg relative">
            ...
            <ul className="text-sm text-foreground space-y-2 font-medium">
              ...
              <li className="flex items-center gap-3"><span className="w-2 h-2 rounded-full bg-line-green shrink-0" />既存システム連携: ◎</li>
      ...
      <Section id="features" spacing="md" container="wide" background="white">
        <div className="mb-10 md:mb-12">
          ...
          <p className="text-base text-muted-foreground">スポーツ・エンタメ業界で特に効く6機能。必要なものだけを選び、フェーズを追って拡張できます。</p>
        </div>
          ...
          <div className="flex flex-col md:flex-row">
            <div className="bg-[#0a0a0a] text-white p-6 sm:p-8 md:p-10 flex flex-col justify-center md:w-2/5">
              ...
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold leading-tight mb-3">
                スポーツ・エンタメ業界<br />LINEミニアプリ活用ガイド 2026
              </h3>
              <p className="text-sm text-white/60 leading-relaxed">試合・公演単発で終わらせない、ファンとの接点づくり。</p>
            </div>
            <div className="p-6 sm:p-8 md:p-10 flex flex-col justify-center md:w-3/5">
              ...
              <WPDownloadButton industry="sports" />
            </div>
          </div>
        </div>
      </Section>
      ...
      {/* ============================================================ */}
      <LpFooter
        description="クラスメソッド株式会社が提供するLINEミニアプリ開発サービス。スポーツ・エンタメ業界のライト層育成・チケット先行・幽霊会員再活性化に対応します。"
        columns={[
          {
            heading: 'SERVICE',
            links: (
